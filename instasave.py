...
#check internet connection Google
def connection(url='http://www.google.com/', timeout=5):
    ...
    return False
# start download instagram photo or video We are working with this part
...
# start download profile picture of instagram accounts We Have nothing to do with this part
def pp_download():
